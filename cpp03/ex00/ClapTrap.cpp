...
/*   Updated: 2022/11/24 12:43:20 by nhwang           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << "copy constructor called" << std::endl; //바꾸기 전 이름 >> 생성자이기 떄문에 무명일것.
	*this = forcpy;
}
ClapTrap& ClapTrap::operator = (const ClapTrap& forass)
{
	std::cout << "copy assignment called" << std::endl; //바꾸기 전 이름
	if (this == &forass)
		return *this;
	Name = forass.getName();
